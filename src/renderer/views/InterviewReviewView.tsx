...
function buildLongAudioOptimizationMarkdown(input: {
  ...
  const fileSizeText = input.selectedFile ? formatFileSize(input.selectedFile.size) : '未知'
...
export function InterviewReviewView({ onOpenSettings }: InterviewReviewViewProps): JSX.Element {
  ...
  return (
    <section className="interview-review-page">
