...
- 设置中心“更新日志”模块已有「检查更新」「下载更新」「重启安装」「重启应用」入口。
...
8. 已安装旧版本的用户启动 App，或在设置中心 → 更新日志点击「检查更新」。
...
6. 在旧版本 App 的“设置 → 更新日志”里点击「检查更新」验收。

## 验收清单

- 开发模式点击「检查更新」提示不会连接自动更新。
- 正式安装包启动 8 秒后自动检查更新，但不会自动下载更新包。
- 没有新版本时提示当前已是最新版本。
- 有新版本时先提示用户，用户点击“下载更新”后才开始下载并显示进度。
- 下载完成后点击「重启安装」能覆盖安装。
