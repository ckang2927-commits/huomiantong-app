...
| Codex 还需要继续做 | 1 | 正在执行 `v0.1.4` 正式发布和线上更新验证 |
| 需要用户人工验收 | 8 | 真实 Key、真实麦克风、真实电脑音频、真实录音、安装版入口等 |
| 本轮暂停 | 2 | 国内语音服务商接入、背景/按钮主题换肤 |
| 发布前仍未完成 | 1 | 线上 Release 完成后，用旧安装版检查更新点测 |
...
| R-4 | 🔵 进行中 | 正式发布安装包和线上更新 | 生成 `0.1.4` 安装包，推送 `v0.1.4` 标签，等待 GitHub Release 产出 `latest.yml` |
...
| 2026-08-04 | Codex | v0.1.4 正式发布准备 | 版本号升到 `0.1.4`，新增完整更新说明，软件内更新弹窗和更新日志同步到本次发布 | 待 `npm run dist`、发布资源检查和线上 Release 验证 |
